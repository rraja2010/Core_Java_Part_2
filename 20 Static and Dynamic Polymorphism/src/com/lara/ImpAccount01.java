...
public class ImpAccount01
{
	public static void main(String[] args)
	{
		...
		Account bsav = new BSavingAccount();
		bsav.withdrow();
		
		Account cSav = new CurrentAccount();
		cSav.withdrow();
		//cSav.overDraft();
		
		Account cacc = new DFixedDeposit();
		cacc.withdrow();
		...
		reference of any child class through that we are accessing the child class 
		method.
	    
	    Account is the top level class
	    
	    why we go for this type we can also create the instance of CA and called 
	    the withdrow()
	    ...
	    and Account is representing many types of Account like SavingAccount,
	    CurrentAccount,FixedDeposit and many other accounts.
	    
	    Here we are achieving static polymorphism or compile time polymorphism.
	    At compile time we decide the program flow.
	    Here at CT we decide the acc is containing the reference of CA and it will 
	    call the withdrow() of corresponding class.	    
