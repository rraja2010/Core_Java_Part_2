...
public class ImpAccount04
{
	public static void main(String[] args)
	{
		...
		/* good here because we are passing the reference of CA to the 
		   withdrowMyAccount(--) so that Account acc is properly downcasted in CA 
		   and acc call the overDraft() method
		*/
